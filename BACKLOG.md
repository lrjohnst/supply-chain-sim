...
| 3 | `[MAP-VERIFY]`-logging opruimen | Laag | Development-only logs in de kaartgeneratie, mogen weg zodra de generatie stabiel is. Stond al als stap 3 in `docs/spec/handoff.md`. |
